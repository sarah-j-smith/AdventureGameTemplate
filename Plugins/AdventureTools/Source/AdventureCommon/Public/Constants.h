...
#define COMMAND_MANAGER_NAV_ERR_KEY 5
#define ADVENTURE_CONTROLLER_SETUP_AI_KEY 6
#define ADVENTURE_CONTROLLER_HOTSPOT_DEBUG_KEY 7
#define INVENTORY_MISSING_DEBUG_KEY 8
